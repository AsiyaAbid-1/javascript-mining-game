...
- **Score Tracking**: Collect diamonds and track progress with a counter.  
- **End Condition**: Reach the level end after collecting all diamonds.  

## 💻 Tech Stack
- HTML (structure and layout)  
- JavaScript (game logic, collisions, player movement, enemy behavior)  

## 🚀 How to Run
1. Download or clone the repository.  
   ```bash
   git clone https://github.com/AsiyaAbid-1/javascript-mining-game.git
